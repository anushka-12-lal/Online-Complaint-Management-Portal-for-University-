          ...
          <?php
            ...
            {?>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li><a href="dis_comp.php">COMPLAINTS</a></li>
                  <li><a href="req_info.php">MANAGE_COMPLAINTS</a></li>
            ...
            {   
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="admin_reg.php"><span class="glyphicon glyphicon-user" > SIGNUP</a></li>
              </ul>
